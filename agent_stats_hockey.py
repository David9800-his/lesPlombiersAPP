...
class StatsManager:
    ...
    def obtenir_stats_joueur_multi_saisons(nom_joueur):
        ...
        for i, saison in enumerate(['2024-2025', '2023-2024', '2022-2023', '2021-2022']):
            if i == 0:  # Saison actuelle
                ...
                # Possibilité qu'un joueur n'était pas là en 2021-2022
                if saison == '2021-2022' and random.random() < 0.3:
                    saisons[saison] = None
                else:
                    saisons[saison] = {
...
def carousel_joueurs(nom_joueur=None):
    ...
    stats_general = StatsManager.calculer_classement_general()
    tous_joueurs = list(stats_general.keys())
    ...
    joueurs_donnees.sort(key=lambda x: (
        x['saisons']['2024-2025']['buts'] + x['saisons']['2024-2025']['passes'] 
        if x['saisons']['2024-2025'] else 0
    ), reverse=True)
